  ...
  return (
    <div className="WalletDetailModal_Container_login">
      ...
      <div className="action_wallet_detail_con_login">
        <button>
          <a href="#"><IoIosSend className='icon_wallet_detail_style_login' />Send</a>
        </button>
        <button>
          <a href="#"><RiDownloadLine className='icon_wallet_detail_style_login' />Receive</a>
        </button>
        <button>
          <a href="#"><FiPlus className='icon_wallet_detail_style_login' />Buy</a>
        </button>
      </div>
