...
const WalletDetailModal = () => {
  ...
  <div className="WalletDetailModal_Container">
    <IoCloseCircleOutline className='icon_close_wallet_detail'/>
    ...
    <div className="action_wallet_detail_con">
        <button><a href="#"><IoIosSend className='icon_wallet_detail_style'/>Send</a></button>
        <button><a href="#"><RiDownloadLine className='icon_wallet_detail_style'/>Receive</a></button>
        <button><a href="#"><FiPlus className='icon_wallet_detail_style'/>Buy</a></button>
    </div>
    <div className="menu_detail_wallet">
        ...
        <div className="item_detail_wallet">
          ...
          <h3>Manage Wallet</h3>
            ...
            <div className="item_detail_wallet_out">
