        ...
        <div className="swapBox">
          <div className="swap_title">
            ...
            <div className="swap_slippage">
              <h6>Slippage 0.5%</h6>
              <CiSettings className='icon_setting_swap'/>
            </div>
          </div>
          <div className="swapInput">
            <input type="number" placeholder="0" value={amount} onChange={handleAmountChange} className='swapInput_input'/>
            <div className="swapInput_con1">
              <div className="swapInput_con2">
                <h4>~$3.00 USD</h4>
                <div className="swapInput_icon">
                  <IoWalletOutline className='icon_wallet_swap' />
                  <h6> 0  Max</h6>
                </div>
              </div>
              <div className="select_swapInput_con2">
                <select value={coinType} onChange={(e)=>setCoinType(e.target.value)} className='select_swap'>
          ...
          <div className="swapInput">
            <input type="text" value={`${convertedAmount} WETH`} disabled className='swapInput_input_con2'/>
            <div className="swapInput_con1">
              <div className="swapInput_con2">
                <h4>~$3.00 USD</h4>
                <div className="swapInput_icon">
          ...
          <div className="swapInput_total_container">
            <h4>Price</h4>
            <div className="swapInput_Total">
              <h4>~ 2,573.22 WETH/USDC</h4>
              <RxSymbol/>
            </div>
          </div>

          <div className="swap_button">
            <div className="swap_btn1">
              <button className='swap_button1'>Swap</button>
            </div>
            <div className="swap_btn2">
              <button className='swap_button2'><RxSymbol /></button>
            </div>
          ...
          <div className="routeBox_box">
            <div className="routeBox_box_fullheader">
              <div className="routeBox_box_icon">
                <img src='https://png.pngtree.com/element_origin_min_pic/16/11/02/bd886d7ccc6f8dd8db17e841233c9656.jpg' alt="icon1" className='route_icon'/>
                <h5>{route.amount}</h5>
              </div>
            ...
            <div className="routeBox_box_fullfooter">
              <div className="routeBox_box_nameSwap">
                <h6>via</h6>
                <img  src='https://media.istockphoto.com/id/1345681613/vi/vec-to/creative-people-logo-vector-thi%E1%BA%BFt-k%E1%BA%BF-c%C3%B3-th%E1%BB%83-thay-%C4%91%E1%BB%95i-eps-10.jpg?s=612x612&w=0&k=20&c=Tfj-b_0b8crwl6ewj3DVUHsNWjEKSchD3n3pknIOH4s=' alt="icon2" className='route_icon2' />
