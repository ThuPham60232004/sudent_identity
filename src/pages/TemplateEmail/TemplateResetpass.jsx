...
// import './TemplateResetpass.css' // Không cần import vì đã chuyển sang inline style
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.content1}>
                <GiPadlock style={styles.icon} />
                <p style={styles.content1Text}>Please reset your password</p>
            </div>
            ...
            <div style={styles.footer}>
                ...
                <div style={styles.rightFooter}>
                    <div style={styles.socialIcons}>
                        <FaFacebookF style={styles.iconSocial} />
                        <FaTwitter style={styles.iconSocial} />
                        <FaInstagram style={styles.iconSocial} />
                        <FaLinkedinIn style={styles.iconSocial} />
                    </div>
...
export default TemplateResetpass;
